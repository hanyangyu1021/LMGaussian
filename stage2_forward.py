...
from utils.graphics_utils import vis_surface_normal, get_dis_from_ts, vis_surface_normal_inverse, interpolate_camera_poses
from gaussian_renderer import render, render_point, network_gui, render_msplat_test, render_test
import sys
import cv2
...
def training(dataset, opt, pipe, testing_iterations, saving_iterations, checkpoint_iterations, checkpoint, debug_from, \
    ...
    for iteration in range(first_iter, opt.iterations + 1): 
        ...
        if iteration in iter_rounds:
                ...
                gaussians.update_learning_rate(500)
