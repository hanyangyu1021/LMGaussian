...
if __name__ == "__main__":
    ...
    parser.add_argument("--test_iterations", nargs="+", type=int, default=[2000, 6000, 9000, 12000])
    parser.add_argument("--save_iterations", nargs="+", type=int, default=[2000, 6000, 9000, 12000])
    parser.add_argument("--quiet", action="store_true")
    parser.add_argument("--checkpoint_iterations", nargs="+", type=int, default=[2000, 6000, 9000, 12000])
